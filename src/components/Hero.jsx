  ...
  return (
    <>
      ...
      <section className="relative flex sm:flex-row flex-col w-full h-screen mx-auto sm:bg-hero bg-hero-mobile overflow-hidden">
        ...
        >
          ...
          <div>
            ...
            <p className={`${styles.heroSubText} mt-2 text-eerieBlack`}>
              A Flutter Developer with 2 years+ of experiences.{" "}
              <br className="sm:block hidden" />
              I'm passionate about building mobile applications and web
              applications.
            </p>
          </div>
        ...
        <div>
          <img
            className="absolute bottom-0 ml-[50vw] lg:ml-[75vw] md:ml-[60vw] xmd:ml-[60vw] 2xl:ml-[83vw] sm:h-[90vh] md:h-[70vh] xl:h-[60vh]"
            src={avatar}
            alt="tuan"
          />
        </div>
