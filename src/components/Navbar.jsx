  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          <div className="sm:w-[50px] sm:h-[50px] w-[45px] h-[45px]">
            <span className="text-3xl text-black font-bold whitespace-nowrap">
              Flutter Developer
            </span>
          </div>
          {/* Uncomment the following lines if you want to use the logo images */}
          {/* <img
            src={logo} 
            alt="logo"
        ...
        <div className="sm:hidden flex flex-1 w-screen justify-end items-center">
          {toggle ? (
            ...
            >
              ...
              <ul className="list-none flex flex-col gap-4 items-start justify-end ml-8">
                {navLinks.map((nav) => (
                  <li
                    id={nav.id}
                    key={nav.id}
